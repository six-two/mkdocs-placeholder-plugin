...
Integer | `int` | <input data-input-for="VALIDATOR_INT">
Integer (positive) | `uint` | <input data-input-for="VALIDATOR_UINT">
Floating Point Number | `float` | <input data-input-for="VALIDATOR_FLOAT">
Floating Point Number (positive) | `ufloat` | <input data-input-for="VALIDATOR_UFLOAT">
