#!/usr/bin/env python3
print("@TODO should_not_be_needed_in_the_future")
# import argparse
# # local files
# from mkdocs_placeholder_plugin.generic.config.placeholder import load_placeholder_data
# from mkdocs_placeholder_plugin.generic.static_replacer import StaticReplacer
